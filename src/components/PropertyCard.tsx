...
export const PropertyCard: React.FC<PropertyCardProps> = ({ 
  ...
  return (
    <>
      <Card style={styles.card} onPress={handleViewDetails}>
        <View style={styles.imageContainer}>
          ...
          <View style={styles.topBadges}>
            ...
            {priceIndicatorDisplay && (
              <Chip 
                ...
                textStyle={{ color: 'white' }}
                icon={() => <Ionicons name={priceIndicatorDisplay.icon as any} size={12} color="white" />}
              >
          ...
          <View style={styles.topActions}>
            ...
            {showFavoriteButton && (
              <IconButton
                icon={property.isFavorite ? "heart" : "heart-outline"}
                size={20}
                iconColor={property.isFavorite ? "#ef4444" : "#6b7280"}
                style={styles.actionButton}
          ...
          <View style={styles.header}>
            ...
            <View style={styles.priceContainer}>
              ...
              <TouchableOpacity onPress={handlePriceIndicatorPress}>
                <Ionicons 
                  name={priceIndicatorDisplay ? priceIndicatorDisplay.icon as any : "cash-outline"} 
                  size={20} 
                  color={priceIndicatorDisplay ? priceIndicatorDisplay.color : "#6b7280"} 
                />
              </TouchableOpacity>
            </View>
          </View>
